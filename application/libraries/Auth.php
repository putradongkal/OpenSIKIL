...
class Auth
{
    ...
    */
    ...
    {
        $this->error["failed"] = "Username atau kata sandi salah.";
...
//                    return true;
//                }
                if($this->inArraySegment($this->CI->uri->segment(1))){
                    if ($method == (is_null($this->CI->uri->segment(3)) ? "index" : $this->CI->uri->segment(3))) {
                        return true;
                    }
                } else {
                    if ($method == (is_null($this->CI->uri->segment(2)) ? "index" : $this->CI->uri->segment(2))) {
...
//        return redirect('exceptions/custom_404', 'refresh');
    ...
    public function inArraySegment($segment)
    {
        $array = ['my'];
        return in_array($segment, $array) ? true : false;
    }
}
