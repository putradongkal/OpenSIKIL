...
280208
 ...
 Security 0
 Insights
CodeIgniter-Google-Maps-V3-API-Library/application/libraries/Googlemaps.php /
@BIOSTALL BIOSTALL fixed bug with scaleControlPosition option not enabling control
1033b71 on May 29, 2014
2263 lines (2033 sloc)  88.3 KB
...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyAqoWGSQYygV-G1P5tVrj-dM2rVHR5wOGY'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
